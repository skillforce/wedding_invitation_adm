...
const themes: Record<ThemeName, ThemeDefinition> = {
  [AppTheme.Dark]: {
    cssVars: {
      ...
      '--color-surface-section': 'rgba(255, 255, 255, 0.04)',
      '--color-surface-hover': 'rgba(255, 255, 255, 0.06)',
      '--color-surface-header': 'rgba(255, 255, 255, 0.06)',
      '--color-budget-card-bg': '#1a2235',
      '--shadow-card': '0 4px 12px rgba(0, 0, 0, 0.35), 0 2px 8px rgba(0, 0, 0, 0.15)',
      '--cl-done': '#7aad8c',
      '--cl-done-bg': 'rgba(122, 173, 140, 0.12)',
      '--cl-priority': '#e8927a',
      '--scenario-icon-filter': 'brightness(0) saturate(100%) invert(80%) sepia(42%) saturate(700%) hue-rotate(4deg) brightness(94%) contrast(88%)',
      '--scenario-icon-accent': '#c9a84c',
      '--scenario-icon-accent-soft': 'rgba(201, 168, 76, 0.18)',
      '--scenario-icon-bg': 'rgba(201, 168, 76, 0.12)',
      '--scenario-icon-bg-active': 'rgba(201, 168, 76, 0.22)',
      '--scenario-line-fade': 'rgba(201, 168, 76, 0.05)',
    },
    board: {
  ...
  [AppTheme.Light]: {
    cssVars: {
      ...
      '--color-surface-section': 'rgba(0, 0, 0, 0.03)',
      '--color-surface-hover': 'rgba(0, 0, 0, 0.05)',
      '--color-surface-header': 'rgba(0, 0, 0, 0.04)',
      '--color-budget-card-bg': '#ffffff',
      '--shadow-card': '0 4px 12px rgba(0, 0, 0, 0.12), 0 2px 8px rgba(0, 0, 0, 0.07)',
      '--cl-done': '#7aad8c',
      '--cl-done-bg': 'rgba(122, 173, 140, 0.12)',
      '--cl-priority': '#e8927a',
      '--scenario-icon-filter': 'brightness(0) saturate(100%) invert(65%) sepia(24%) saturate(449%) hue-rotate(109deg) brightness(96%) contrast(89%)',
      '--scenario-icon-accent': '#5a9e7a',
      '--scenario-icon-accent-soft': 'rgba(90, 158, 122, 0.18)',
      '--scenario-icon-bg': 'rgba(90, 158, 122, 0.10)',
      '--scenario-icon-bg-active': 'rgba(90, 158, 122, 0.20)',
      '--scenario-line-fade': 'rgba(90, 158, 122, 0.05)',
    },
    board: {
